...
| `Summary`          |    Boundary    | /compact                | Context start boundary             |
| `ApprovalRequest`  |       No       | Approval proxy (daemon) | Control: tool approval requested   |
| `ApprovalDecision` |       No       | Bridge                  | Control: human's approval decision |
